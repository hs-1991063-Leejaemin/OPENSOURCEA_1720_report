...
- [MySQL](https://github.com/mysql/mysql-server)
  ...
  - 무료 버전과 유료 버전 존재, 무료 버전은 GPL 라이선스가 적용되어 소스코드 수정 배포시 수정된 코드도 제공해야함. 유료 버전은 자체 상용 라이선스이기에 수정한 소스코드의 공개 의무가 없음.
  - 다양한 프로그래밍 언어를 위한 API 제공
  - 크기가 큰 데이터 집합을 빠르고 효과적으로 처리할 수 있으며, 표준 SQL 형식을 따름
  - 타 라이선스와의 충돌을 방지하기 위해 자체 상용 라이선스를 구매하여 사용해야할 듯 함.
